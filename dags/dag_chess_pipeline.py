...
def load_data():
    ...
    tasks.add_run(pipeline, source(["magnuscarlsen", "vincentkeymer", "dommarajugukesh", "rpragchess"]), decompose="serialize", trigger_rule="all_done", retries=0, provide_context=True)
